let t,e,i,n,r,s,o,l,a,h,u,d,c,g,f;function _(t){return t&&t.__esModule?t.default:t}var m=/**
 ...
 */class{/**
   ...
   */getPointResolutionFunc(){return this.getPointResolutionFunc_}};const tk=6378137*Math.PI,tN=[-tk,-tk,tk,tk],tG=[-180,-85,180,85],tz=6378137*Math.log(Math.tan(Math.PI/2));/**
 * @classdesc
 * Projection object for web/spherical Mercator (EPSG:3857).
 */class tX extends tD{/**
   * @param {string} code Code.
   */constructor(t){super({code:t,units:"m",extent:tN,global:!0,worldExtent:tG,getPointResolution:function(t,e){return t/Math.cosh(e[1]/6378137)}})}}const tW=[new tX("EPSG:3857"),new tX("EPSG:102100"),new tX("EPSG:102113"),new tX("EPSG:900913"),new tX("http://www.opengis.net/def/crs/EPSG/0/3857"),new tX("http://www.opengis.net/gml/srs/epsg.xml#3857")],tY=[-180,-90,180,90],tU=6378137*Math.PI/180;/**
 * @classdesc
 ...
 */class tj extends tD{/**
   ...
   */constructor(t,e){super({code:t,units:"degrees",extent:tY,axisOrientation:e,global:!0,metersPerUnit:tU,worldExtent:tY})}}const tB=[new tj("CRS:84"),new tj("EPSG:4326","neu"),new tj("urn:ogc:def:crs:OGC:1.3:CRS84"),new tj("urn:ogc:def:crs:OGC:2:84"),new tj("http://www.opengis.net/def/crs/OGC/1.3/CRS84"),new tj("http://www.opengis.net/gml/srs/epsg.xml#4326","neu"),new tj("http://www.opengis.net/def/crs/EPSG/0/4326","neu")];/**
 * @module ol/proj/projections
 *//**
 * @type {Object<string, import("./Projection.js").default>}
 */let tK={},tZ={};function tV(t,e,i){let n=t.getCode(),r=e.getCode();n in tZ||(tZ[n]={}),tZ[n][r]=i}/**
 * @module ol/math
 *//**
 ...
 * @type {RegExp}
 * @private
 */const eS=/^#([a-f0-9]{3}|[a-f0-9]{4}(?:[a-f0-9]{2}){0,2})$/i,eR=/^([a-z]*)$|^hsla?\(.*\)$/i;function ew(t){return"string"==typeof t?t:eL(t)}const eT=function(){/**
 ...
 */function eO(t,e,i){let n=i?ew(i):"null";return e+":"+t+":"+n}const eD=new /**
 ...
 */let ek=null;class eN extends M{/**
 ...
 * @type {CanvasRenderingContext2D}
 */let ik=null;const iN={},iG=function(){let t,i;let n="32px ",r=["monospace","serif"],s=r.length,o="wmytzilWMYTZIL@#/&?$%10";/**
 ...
 * @module ol/xml
 */const iQ="http://www.w3.org/2001/XMLSchema-instance";function i0(t,e){return no().createElementNS(t,e)}function i1(t,e){return(function t(e,i,n){if(e.nodeType==Node.CDATA_SECTION_NODE||e.nodeType==Node.TEXT_NODE)i?n.push(String(e.nodeValue).replace(/(\r\n|\r|\n)/g,"")):n.push(e.nodeValue);else{let r;for(r=e.firstChild;r;r=r.nextSibling)t(r,i,n)}return n})(t,e,[]).join("")}function i2(t){return"documentElement"in t}function i3(t){return new DOMParser().parseFromString(t,"application/xml")}function i5(t,e){return(/**
 ...
 * @param {Array<*>} objectStack Object stack.
 * @this {KML}
 */function(t,e,i){ns({node:t},rh,ru,e,i,void 0,this)}),Placemark:i7(rO)});/**
 * @type {Fill|null}
 */let nR=null,nw=null,nT=null,nI=null,nM=null;/**
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const nj=ni(nf,{Track:i4(nK)}),nB=ni(n_,{when:/**
 * @param {Node} node Node.
 * @param {Array<*>} objectStack Object stack.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const nZ=ni(n_,{href:i8(nF)},ni(nf,{x:i8(nh),y:i8(nh),w:i8(nh),h:i8(nh)})),nV=ni(n_,{coordinates:i6(nP)});/**
 * @param {Element} node Node.
 * @param {Array<*>} objectStack Object stack.
 * @return {Array<number>} Flat coordinates.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const nq=ni(n_,{extrude:i8(na),tessellate:i8(na),altitudeMode:i8(nu)});/**
 * @param {Element} node Node.
 * @param {Array<*>} objectStack Object stack.
 * @return {LineString|undefined} LineString.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const nQ=ni(n_,{LineString:i4(nJ),LinearRing:i4(n$),MultiGeometry:i4(n0),Point:i4(n1),Polygon:i4(n3)});/**
 * @param {Element} node Node.
 * @param {Array<*>} objectStack Object stack.
 * @return {import("../geom/Geometry.js").default} Geometry.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const n2=ni(n_,{innerBoundaryIs:/**
 * @param {Element} node Node.
 * @param {Array<*>} objectStack Object stack.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const n8=ni(n_,{displayName:i8(nu),value:i8(nu)}),n7=ni(n_,{Data:/**
 * @param {Element} node Node.
 * @param {Array<*>} objectStack Object stack.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Parser>>}
 */// @ts-ignore
const re=ni(n_,{Style:i8(n4),key:i8(nu),styleUrl:i8(nO)}),ri=ni(n_,{SimpleData:/**
 * @param {Element} node Node.
 * @param {Array<*>} objectStack Object stack.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Serializer>>}
 */// @ts-ignore
const rL=ni(n_,{LinearRing:i7(rN)});/**
 * @param {Element} node Node.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Serializer>>}
 */// @ts-ignore
const rA=ni(n_,{ExtendedData:i7(/**
 * @param {Element} node Node.
 ...
 */// @ts-ignore
const rD=ni(n_,["extrude","tessellate","altitudeMode","coordinates"]),rk=ni(n_,{extrude:i7(nd),tessellate:i7(nd),altitudeMode:i7(ng),coordinates:i7(/**
 ...
 * @type {Object<string, Array<string>>}
 */// @ts-ignore
const rG=ni(n_,["color","fill","outline"]),rz=ni(n_,{outerBoundaryIs:i7(rb),innerBoundaryIs:i7(rb)}),rX=i9("innerBoundaryIs"),rW=i9("outerBoundaryIs");/**
 * @param {Element} node Node.
 * @param {Polygon} polygon Polygon.
 * @param {Array<*>} objectStack Object stack.
 ...
 * @type {Object<string, Object<string, import("../xml.js").Serializer>>}
 */// @ts-ignore
const rU=ni(n_,{color:i7(rl),fill:i7(nd),outline:i7(nd)});/**
 ...
 * @type {Object<string, Array<string>>}
 */// @ts-ignore
const rB=ni(n_,["IconStyle","LabelStyle","LineStyle","PolyStyle"]),rK=ni(n_,{IconStyle:i7(/**
 * @param {Element} node Node.
 ...
 * @enum {string}
 * @private
 */const rH={LENGTH:"length"};class rq extends m{/**
...
let h=[(t[0]+e[0])/2,(t[1]+e[1])/2],u=this.transformInv_(h),d=[(i[0]+n[0])/2,(i[1]+n[1])/2],c=this.transformInv_(d);this.addQuad_(t,h,d,n,r,u,c,l,a-1),this.addQuad_(h,e,i,d,u,s,o,c,a-1)}return}}if(c){if(!this.canWrapXInSource_)return;this.wrapsXInSource_=!0}(11&f)==0&&this.addTriangle_(t,i,n,r,o,l),(14&f)==0&&this.addTriangle_(t,i,e,r,o,s),f&&((13&f)==0&&this.addTriangle_(e,n,t,s,l,r),(7&f)==0&&this.addTriangle_(e,n,i,s,l,o))}/**
   ...
   */getTriangles(){return this.triangles_}};const od=[];/**
 ...
 */class extends F{/**
   ...
   * Clean up.
   */disposeInternal(){delete this.layer_,super.disposeInternal()}};const oz=[];/**
 * @type {CanvasRenderingContext2D}
 */let oX=null;var oW=/**
 * @abstract
 * @template {import("../../layer/Layer.js").default} LayerType
 ...
 * expression.
 */let oj=0;const oB=1<<oj++,oK=1<<oj++,oZ=1<<oj++,oV=1<<oj++,oH=1<<oj++,oq=Math.pow(2,oj)-1,oJ={[oB]:"boolean",[oK]:"number",[oZ]:"string",[oV]:"color",[oH]:"number[]"},o$=Object.keys(oJ).map(Number).sort(x);function oQ(t){let e=[];for(let i of o$)(t&i)===i&&e.push(oJ[i]);return 0===e.length?"untyped":e.length<3?e.join(" or "):e.slice(0,-1).join(", ")+", or "+e[e.length-1]}class o0{/**
 ...
 * @enum {string}
 * @private
 */const lv={RENDER_ORDER:"renderOrder"};var lE=/**
 * @classdesc
 ...
 *//**
 * @enum {number}
 */const lC={BEGIN_GEOMETRY:0,BEGIN_PATH:1,CIRCLE:2,CLOSE_PATH:3,CUSTOM:4,DRAW_CHARS:5,DRAW_IMAGE:6,END_GEOMETRY:7,FILL:8,MOVE_TO_LINE_TO:9,SET_FILL_STYLE:10,SET_STROKE_STYLE:11,STROKE:12},lS=[lC.FILL],lR=[lC.STROKE],lw=[lC.BEGIN_PATH],lT=[lC.CLOSE_PATH];var lI=/**
...
let t=this.tolerance;if(0!==t){let e=this.coordinates;for(let i=0,n=e.length;i<n;++i)e[i]=eq(e[i],t)}return super.finish()}/**
   * @private
   */setFillStrokeStyles_(){let t=this.state,e=t.fillStyle;void 0!==e&&this.updateFillStyle(t,this.createFill),void 0!==t.strokeStyle&&this.updateStrokeStyle(t,this.applyStroke)}};const lP={left:0,center:.5,right:1,top:0,middle:.5,hanging:.2,alphabetic:.8,ideographic:.8,bottom:1};var lF=class extends lM{/**
   * @param {number} tolerance Tolerance.
   * @param {import("../../extent.js").Extent} maxExtent Maximum extent.
   * @param {number} resolution Resolution.
   * @param {number} pixelRatio Pixel ratio.
 ...
 */const lO={Circle:lA,Default:lM,Image:lL,LineString:lb,Polygon:lA,Text:lF};var lD=class{/**
   * @param {number} tolerance Tolerance.
 ...
 */const lK=["Polygon","Circle","LineString","Image","Text","Default"],lZ={};var lV=class{/**
 ...
 */class extends lE{/**
   ...
   */constructor(t){super(t)}createRenderer(){return new lQ(this)}};const l1=new oU({source:new oD({attributions:'<a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',url:"https://c.tile.openstreetmap.org/{z}/{x}/{y}.png",tileSize:256,crossOrigin:null})}),l2=[l1],l3=["#1abc9c","#2ecc71","#3498db","#9b59b6","#34495e","#d35400","#e74c3c","#c0392b","#2c3e50","#fa8231","#eb3b5a","#0fb9b1"];var l5=new XMLHttpRequest;l5.open("GET","./kmlssimple/kml_list.json",!1),l5.send(null);const l4=JSON.parse(l5.responseText);console.log(l4),l4.forEach(t=>{//console.log(file);
var e=new ip({color:l3[Math.floor(Math.random()*l3.length)],width:2.25});l2.push(new l0({style:new iK({stroke:e}),source:new ol({url:"kmlssimple/"+t,format:new rZ({extractStyles:!1})})}))});const l6=new ol,l8=new l0({source:l6});l2.push(l8);//console.log(rasterAndKmls);
const l7=new s7({layers:l2,target:document.getElementById("map"),view:new so({center:eu([9.993682,53.551086],"EPSG:4326","EPSG:3857"),projection:"EPSG:3857",zoom:4})}),l9=function(t){let e=[];if(l7.forEachFeatureAtPixel(t,function(t){e.push(t)}),e.length>0){let t,i;let n=[];for(t=0,i=e.length;t<i;++t)n.push(e[t].get("name"));document.getElementById("info").innerHTML=n.join(", ")||"(unknown)",l7.getTarget().style.cursor="pointer"}else document.getElementById("info").innerHTML="&nbsp;",l7.getTarget().style.cursor=""};l7.on("pointermove",function(t){if(t.dragging)return;let e=l7.getEventPixel(t.originalEvent);l9(e)}),l7.on("click",function(t){l9(t.pixel)}),navigator.geolocation.watchPosition(function(t){var e;let i=[t.coords.longitude,t.coords.latitude],n=function(t,e,i,n){i=i||32;/** @type {Array<number>} */let r=[];for(let n=0;n<i;++n)E(r,function(t,e,i,n){n=n||6371008.8;let r=t$(t[1]),s=t$(t[0]),o=e/n,l=Math.asin(Math.sin(r)*Math.cos(o)+Math.cos(r)*Math.sin(o)*Math.cos(i)),a=s+Math.atan2(Math.sin(i)*Math.sin(o)*Math.cos(r),Math.cos(o)-Math.sin(r)*Math.sin(l));return[tJ(a),tJ(l)]}(t,e,2*Math.PI*n/i,void 0));return r.push(r[0],r[1]),new ig(r,"XY",[r.length])}(i,t.coords.accuracy);l6.clear(!0),l6.addFeatures([new X(n.transform("EPSG:4326",l7.getView().getProjection())),new X(new ii((t9(),eu(i,"EPSG:4326",void 0!==e?e:"EPSG:3857"))))])},function(t){alert(`ERROR: ${t.message}`)},{enableHighAccuracy:!0});const at=document.createElement("div");at.className="ol-control ol-unselectable locate",at.innerHTML='<button title="Locate me">◎</button>',at.addEventListener("click",function(){l6.isEmpty()||l7.getView().fit(l6.getExtent(),{maxZoom:18,duration:500})}),l7.addControl(new sI({element:at}));//# sourceMappingURL=index.4d2c0200.js.map

//# sourceMappingURL=index.4d2c0200.js.map
